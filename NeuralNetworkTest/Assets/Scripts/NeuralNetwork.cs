...
public class NeuralNetwork : IComparable<NeuralNetwork>
{
    ...
    public UnityEngine.GameObject Agent { get; set; }
    ...
    public NeuralNetwork(NeuralNetwork copyNetwork, UnityEngine.GameObject oldAgent)
    {
        ...
        Agent = oldAgent;
        Agent.GetComponent<Agent>().SetNeuralNetwork(this);
